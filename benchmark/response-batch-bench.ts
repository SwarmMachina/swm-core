 ...
 * @returns {number|null}
 */
function percentDelta(value: number | null | undefined, baseline: number | null | undefined): number | null {
  if (
    value === null ||
    value === undefined ||
    baseline === null ||
 ...
 * @returns {number|null}
 */
function pairedRpsDelta(bench: BenchData): number | null {
