...
import { requireMetric, type BenchmarkRow, type BenchmarkSummary, type PackageManifest } from '../harness/types.js'

const __dirname = path.dirname(fileURLToPath(import.meta.url))
const ROOT = REPOSITORY_ROOT

const PARAMS = {
  runs: positiveEnvNumber('DEEP_BINDING_RUNS', 6),
  warmup: positiveEnvNumber('DEEP_BINDING_WARMUP', 2),
  duration: positiveEnvNumber('DEEP_BINDING_DURATION', 5),
  sampleMs: positiveEnvNumber('DEEP_BINDING_SAMPLE_MS', 250)
}
