...
const REQUIRED_FILES = ['LICENSE', 'README.md', 'package.json', 'src/index.d.ts', 'src/index.js']
...
export function verifyPackedFiles(files) {
  ...
  for (const file of paths) {
    if (!ALLOWED_ROOT_FILES.has(file) && !file.startsWith('src/')) {
...
/**
 * Build and describe the exact tarball that the publish job will receive.
 * @returns {Promise<void>}
 */
async function main() {
