 ...
 */
export function validateWsClose(code: number, reason: string): void {
...
export function parseWsProtocols(requestedHeader: string): readonly string[] {
...
export function validateWsProtocolSelection(requested: readonly string[], selected: unknown): string {
