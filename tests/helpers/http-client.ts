 ...
 */
export async function reqText(url: string, opt: RequestInit = {}) {
 ...
 */
export async function reqJson(url: string, opt: RequestInit = {}) {
  const res = await fetch(url, opt)
 ...
 */
export async function reqBin(url: string, opt: RequestInit = {}) {
  const res = await fetch(url, opt)
